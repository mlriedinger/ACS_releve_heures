...
function displayWorkCategories(data) {
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="number" name="workstationLengthHours[${ categoryId }]" id="${ categoryCode }LengthHours" value="0" class="form-control timeInput" aria-label="Indiquez le nombre d'heures pour le poste ${ categoryLib }" aria-describedby="${ categoryCode }_hours_indicator"/>
                        </div>
    ...
    var newDivCategory = document.createElement("div");
    newDivCategory.setAttribute("id", "divTotal");
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="number" readonly step="15" max="60" name="totalLengthMinutes" value="0" id="totalLengthMinutes" class="form-control" aria-label="Total des heures de la journée" aria-describedby="total_minutes_indicator" required/>
                    </div>
                </div>
            </div>
        </div>`
