    ...
    <div class="row mb-5">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="all_records_tab" onclick="updateRecordsLog('user', 'all')" data-bs-toggle="tab" data-bs-target="#all_records" type="button" role="tab" aria-controls="all_records_tab" aria-selected="true">Tous</button>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pending_records_tab" onclick="updateRecordsLog('user', 'pending')" data-bs-toggle="tab" data-bs-target="#pending_records" type="button" role="tab" aria-controls="pending_records_tab" aria-selected="false" <?= $_SESSION['userGroup'] == 1 ? "hidden" : "" ?>>En attente</button>
            </li>
            <li class="nav-item" role="presentation">
